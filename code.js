...
const newYearsResolutions = ["Wine", "Workout", "Meditation"];
...
const printDogNameUppercase = (dogname) => {
  ...
  console.log("To uppercase:", uppercaseName);
};
...
dogs.forEach((dogname) => {
  console.log(`The ${dogname} goes for a walk`);
});
...
// When removing return the map is an array with 5x undefined
...
person.favoriteFoods = ["Tacos", "Fish", "Barbeque"];
